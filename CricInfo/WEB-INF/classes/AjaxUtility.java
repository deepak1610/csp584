...
public class AjaxUtility {
	...
	public static void storeData(HashMap<String,Product> productdata)
	{
		try
		{
			...
			String insertIntoProductQuery = "INSERT INTO productdetails(ProductType,Id,productName,productPrice,productImage,productDiscount) "
				+ "VALUES (?,?,?,?,?,?,?,?);";
				for(Map.Entry<String, Product> entry : productdata.entrySet())
				{
					...
					pst.setDouble(6,entry.getValue().getDiscount());
					pst.execute();
				}
		}
		catch(Exception e)

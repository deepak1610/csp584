...
public class Inventory extends HttpServlet {
    ...
    protected void displayInventory(HttpServletRequest request,
        ...
        //Table of Inventory
        pw.print("<div id='content002'>");
        pw.print("<div class='post002'>");
        pw.print("<center><h2 class='title'style= 'width: 1082px;'>");
        pw.print("INVENTORY REPORT");
        pw.print("</h2></center>");
        pw.print("<center><h2 class='title'>");
        ...
        pw.print("<td><b>Price </b></td>");
        pw.print("<td><b>Inventory </b></td>");
        pw.print("</tr>");
      ...
      //  Table of all products currently on sale
        // pw.print("<div id='content004'>");
        // pw.print("<div class='post004'>");
        // pw.print("<center><h2 class='title'>");
      ...
      //  Table of all products currently that have manufacturer rebates
        pw.print("<div id='content005'>");
        pw.print("<div class='post005'>");
        pw.print("<center><h2 class='title'>");

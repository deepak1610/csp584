...
public class TeamCrud extends HttpServlet {
	protected void doGet(HttpServletRequest request,
			...
			if (action.equals("add") || action.equals("update"))
			{
				...
				// teamManufacturer = request.getParameter("teamManufacturer");
				 //teamCondition = request.getParameter("teamCondition");
				 //teamDiscount = Double.parseDouble(request.getParameter("teamDiscount"));

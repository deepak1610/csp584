...
public class AjaxUtility {
	...
	public static String getConnection()
	{
		...
		try
		{
			...
			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/csp584","root","deepak");
			message="Successfull";
			return message;
		}
	...
	public static void storeData(HashMap<String,Product> productdata)
	{
		try
		{
			...
			String insertIntoProductQuery = "INSERT INTO productdetails(ProductType,Id,productName,productPrice,productCondition,productDiscount) "
			+ "VALUES (?,?,?,?,?,?,?,?);";
			for(Map.Entry<String, Product> entry : productdata.entrySet())
			{
				...
				// pst.setString(6,entry.getValue().getRetailer());

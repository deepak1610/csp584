...
public class DealMatchesUtilities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<a href='#'>Deal Matches with BestBuy </a></h2>");

		pw.print("<div class='entry'>");
		pw.print("<h2>Our Best Deals </h2>");
		// pw.print("<img src='images/laptop/1.png'style='width: 600px; display: block; margin-left: auto; margin-right: auto' />");
		// pw.print("<br> <br>");
